...
export declare function updateChangeInfoWithMaxType(changeInfo: ChangeInfo, inputA: ChangeType, inputB: ChangeType, disallowedChangeTypes: ChangeType[] | null): ChangeInfo;
