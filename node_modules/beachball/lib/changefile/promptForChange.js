...
function promptForChange(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let pkg of changedPackages) {
            ...
            if ((_b = packageInfo.combinedOptions.changeFilePrompt) === null || _b === void 0 ? void 0 : _b.changePrompt) {
                questions = (_c = packageInfo.combinedOptions.changeFilePrompt) === null || _c === void 0 ? void 0 : _c.changePrompt(defaultPrompt);
            }
            ...
            packageChangeInfo[pkg] = Object.assign(Object.assign({}, response), { packageName: pkg, email: workspace_tools_1.getUserEmail(cwd) || 'email not defined', dependentChangeType: options.dependentChangeType || (response.type === 'none' ? 'none' : 'patch') });
        }
