...
exports.packageJsonFixtures = ['repo-a', 'repo-b'].reduce((fixtures, repo) => (Object.assign(Object.assign({}, fixtures), { [`${repo}`]: {
        private: true,
        name: repo,
        version: '1.0.0',
        workspaces: {
...
class MultiMonoRepoFactory extends repository_1.RepositoryFactory {
    create() {
        const originalDirectory = process.cwd();
        this.root = tmpdir_1.tmpdir({ prefix: 'beachball-multi-monorepository-upstream-' });
        ...
        tmpRepo.commitChange('repo-a/beachball.config.js', 'module.exports = ' + JSON.stringify(beachballConfigFixture, null, 2));
        tmpRepo.commitChange('repo-b/beachball.config.js', 'module.exports = ' + JSON.stringify(beachballConfigFixture, null, 2));
        tmpRepo.push('origin', 'HEAD:master');
        process.chdir(originalDirectory);
    }
}
exports.MultiMonoRepoFactory = MultiMonoRepoFactory;
//# sourceMappingURL=multiMonorepo.js.map