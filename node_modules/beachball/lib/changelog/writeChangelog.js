...
function writeChangelog(options, changeSet, dependentChangeInfos, packageInfos) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const groupedChangelogPaths = yield writeGroupedChangelog(options, changeSet, dependentChangeInfos, packageInfos);
        const groupedChangelogPathSet = new Set(groupedChangelogPaths);
        const changelogs = getPackageChangelogs_1.getPackageChangelogs(changeSet, dependentChangeInfos, packageInfos);
...
function writeGroupedChangelog(options, changeSet, dependentChangeInfos, packageInfos) {
    return __awaiter(this, void 0, void 0, function* () {
