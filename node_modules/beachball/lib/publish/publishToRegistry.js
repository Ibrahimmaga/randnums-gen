...
const performPublishConfigOverrides_1 = require("./performPublishConfigOverrides");
function publishToRegistry(originalBumpInfo, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        performPublishConfigOverrides_1.performPublishConfigOverrides(packagesToPublish, bumpInfo.packageInfos);
        ...
        for (const pkg of packagesToPublish) {
            ...
            let retries = 0;
            do {
                result = packagePublish_1.packagePublish(packageInfo, registry, token, access, timeout);
                if (result.success) {
