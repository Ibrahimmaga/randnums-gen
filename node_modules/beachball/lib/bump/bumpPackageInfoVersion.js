...
function bumpPackageInfoVersion(pkgName, bumpInfo, options) {
    ...
    const changeType = (_a = packageChangeTypes[pkgName]) === null || _a === void 0 ? void 0 : _a.type;
    if (!info) {
    ...
    if (!info.private) {
        info.version = semver_1.default.inc(info.version, changeType, options.prereleasePrefix);
