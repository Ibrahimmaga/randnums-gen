...
describe('version bumping', () => {
    ...
    it('bumps only packages with change files committed between specified ref and head using `since` flag', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const revParseOutput = workspace_tools_1.git(['rev-parse', 'HEAD'], { cwd: repo.rootPath });
    ...
    it('should not bump out-of-scope package and its dependencies even if dependency of the package has change', () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        repositoryFactory = new monorepo_1.MonoRepoFactory();
        yield repositoryFactory.create();
        const repo = yield repositoryFactory.cloneRepository();
        ...
        expect((_a = packageInfos['foo'].dependencies) === null || _a === void 0 ? void 0 : _a.bar).toBe('^1.3.4');
        const changeFiles = getChangeFiles(repo.rootPath);
        expect(changeFiles.length).toBe(0);
    }));
    ...
    it('bumps all packages and uses prefix in the version', () => __awaiter(void 0, void 0, void 0, function* () {
        repositoryFactory = new repository_1.RepositoryFactory();
        yield repositoryFactory.create();
        const repo = yield repositoryFactory.cloneRepository();
        yield repo.commitChange('packages/pkg-1/package.json', JSON.stringify({
    ...
    it('bumps all packages and uses prefixed versions in dependents', () => __awaiter(void 0, void 0, void 0, function* () {
        repositoryFactory = new repository_1.RepositoryFactory();
        yield repositoryFactory.create();
        const repo = yield repositoryFactory.cloneRepository();
        yield repo.commitChange('packages/pkg-1/package.json', JSON.stringify({
    ...
    it('bumps all packages and increments prefixed versions in dependents', () => __awaiter(void 0, void 0, void 0, function* () {
        repositoryFactory = new repository_1.RepositoryFactory();
        yield repositoryFactory.create();
        const repo = yield repositoryFactory.cloneRepository();
        yield repo.commitChange('packages/pkg-1/package.json', JSON.stringify({
