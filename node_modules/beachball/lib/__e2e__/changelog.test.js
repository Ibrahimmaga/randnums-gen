...
function getChange(partialChange = {}) {
    return Object.assign({ comment: 'comment 1', email: 'test@testtestme.com', packageName: 'foo', type: 'patch', dependentChangeType: 'patch' }, partialChange);
}
...
describe('changelog generation', () => {
    ...
    describe('writeChangelog', () => {
        it('generates correct changelog', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const dependentChangeInfos = new Array();
            dependentChangeInfos.push(Object.assign(Object.assign({}, getChange({ comment: 'additional comment 1' })), { commit: '' }));
            dependentChangeInfos.push(Object.assign(Object.assign({}, getChange({ comment: 'additional comment 2' })), { commit: '' }));
            yield writeChangelog_1.writeChangelog(beachballOptions, changes, dependentChangeInfos, packageInfos);
        ...
        it('generates correct grouped changelog', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield writeChangelog_1.writeChangelog(beachballOptions, changes, new Array(), packageInfos);
