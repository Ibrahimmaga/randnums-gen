...
describe('packageManager', () => {
    ...
    describe('packagePublish', () => {
        ...
        it('can publish', () => {
            const publishResult = packagePublish_1.packagePublish(package_1.testPackageInfo, registry.getUrl(), '', '');
        ...
        it('errors on republish', () => {
            let publishResult = packagePublish_1.packagePublish(package_1.testPackageInfo, registry.getUrl(), '', '');
            expect(publishResult.success).toBeTruthy();
            publishResult = packagePublish_1.packagePublish(package_1.testPackageInfo, registry.getUrl(), '', '');
        ...
        it('publish package with defaultNpmTag publishes as defaultNpmTag', () => {
            const testPackageInfoWithDefaultNpmTag = Object.assign(Object.assign({}, package_1.testPackageInfo), { combinedOptions: { gitTags: true, tag: null, defaultNpmTag: package_1.testTag, disallowedChangeTypes: null } });
            const publishResult = packagePublish_1.packagePublish(testPackageInfoWithDefaultNpmTag, registry.getUrl(), '', '');
            expect(publishResult.success).toBeTruthy();
        ...
        it('publish with specified tag overrides defaultNpmTag', () => {
            const testPackageInfoWithDefaultNpmTag = Object.assign(Object.assign({}, package_1.testPackageInfo), { combinedOptions: { gitTags: true, tag: package_1.testTag, defaultNpmTag: 'thisShouldNotBeUsed', disallowedChangeTypes: null } });
            const publishResult = packagePublish_1.packagePublish(testPackageInfoWithDefaultNpmTag, registry.getUrl(), '', '');
            expect(publishResult.success).toBeTruthy();
            const showResult = npm_1.npm([
                '--registry',
